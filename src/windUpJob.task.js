...
module.exports = async (result) => {
  ...
  const [_, major, minor, patch, prerelease, buildmetadata] =
  ...
  core.setOutput(outputs.new_release_prerelease_version, prerelease);
  core.setOutput(outputs.new_release_buildmetadata, buildmetadata);
